...
# context = {'command': 'splunk-get-indexes', 'args': {}, 'params': {'host': 'splunk.query.ai', 'port': '8089', 'authentication': {'identifier': 'admin', 'password': '#Irisiris20'}}, 'integration': True, 'IsDebug': True}
# demisto = Demisto(context)
params = demisto.params()
params['unsecure'] = False
params['fetch_limit'] = 40
...
def request(url, message):
    ...
    req = urllib.request.Request(url, data, headers)  # guardrails-disable-line
    ...
    try:
        response = urllib.request.urlopen(req, context=context)  # guardrails-disable-line
    except urllib.error.HTTPError as response:  # noqa: F841
...
if __name__ in ['__main__', '__builtin__', 'builtins']:
    print(demisto.command())
    params = demisto.params()
    # params['host'] = 'https://splunk.query.ai'
    print(demisto.params())
    context = {'command': 'splunk-search', 'args': {'query': 'index=ms365'}, 'params': {'host': 'splunk.query.ai', 'port': '8089', 'authentication': {'identifier': 'admin', 'password': '#Irisiris20'}}, 'integration': True, 'IsDebug': True}
    main(context)
